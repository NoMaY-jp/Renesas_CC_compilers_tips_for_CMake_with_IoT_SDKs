...
# This is not necessary because C99 is specifed in CMakeLists.txt globally i.e. before the project() command.
...
string(JOIN " " CMAKE_C_FLAGS   ${CMAKE_C_FLAGS}   ${INTELLISENSE_HELPER_C_FLAGS})
string(JOIN " " CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} ${INTELLISENSE_HELPER_CXX_FLAGS})
